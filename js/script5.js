$(function(){
  ...
  $(".list>li:last-child").css("text-decoration","underline"); //.list 자식 li 중 마지막 요소 선택
  $(".list>li").last().css("background","green"); //.list 자식 li 중 마지막 요소 선택
  $(".list2 li").eq(0).css("color","red"); //.list2 li의 인덱스번호가 0인 요소 선택
  $(".list").find(".sub").css("color","blue"); //.list 자손 중 ".sub" 선택
